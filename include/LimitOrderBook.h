...
private:
    ...
    std::unordered_map<uint64_t, OrderNode*> OrderHashMap; //does not need two of these because this is only mean to do fast lookup, so add both ask and bid orders in here too.
